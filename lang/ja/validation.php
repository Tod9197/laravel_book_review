...
return [
    ...
    'required_if_accepted' => ':attributeは、:otherが承認された場合は、入力必須です。',
    'required_if_declined' => ':attributeは、:otherが拒否された場合は、入力必須です。',
    ...
    */
    ...
    'custom' => [
    'category_id' => [
        'required' => 'カテゴリーは必須項目です。',
        'exists' => '選択されたカテゴリーは存在しません。',
    ],
    'genres' => [
        'required' => 'ジャンルは必須項目です。',
        'array' => 'ジャンルは配列でなければなりません。',
    ],
    'terms' => [
